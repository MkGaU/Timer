...
var stopWatcher = {
	...
	_btStage : 0, //Button status 0 is clear and 1 is check
	...
	stopWatcher: function() {
        ...
        btStart.addEventListener("click",function(event){
            ...
            btStart.style.pointerEvents = 'none';
        });        
        ...
        btStop.addEventListener("click", function() {
            ...
            stopWatcher.changeStage();
            btStart.style.pointerEvents = 'auto';
        });
    },    
    timeRun: function() {
        this._milliSeconds++;
    ...
    clear: function() {
    	...
    	btClear.addEventListener("click",function(){
    		...
    		stopWatcher.displayStopWatcher();
            for (var i = 1; i <=3; i++) {
                var el = document.getElementById("timeChecked_"+i);
                stopWatcher.displayStopWatcher(el);
            }		
    	});
    },
    check: function() {
